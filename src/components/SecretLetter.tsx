...
const letterLines = [
  ...
  "dari banyaknya hal baik",
  "yang akan datang untukmu.",
  "",
  "Aku berharap kamu selalu diberi",
  "kesehatan, kebahagiaan,",
  "dan dikelilingi orang-orang",
  "yang benar-benar menyayangimu.",
  "",
  "Kalau belakangan ini ada hal-hal",
  "yang membuatmu lelah,",
  "semoga perlahan semuanya membaik.",
  "",
  "Semoga langkahmu selalu dipenuhi",
  "kesempatan baik,",
  "cerita baru yang indah,",
  "dan mimpi-mimpi yang satu per satu",
  "berhasil kamu wujudkan.",
  "",
  "Terima kasih...",
  "karena tanpa sadar",
  "kamu sudah menjadi seseorang",
  "yang meninggalkan kesan baik.",
  "",
  "Aku senang mengenalmu.",
  "",
  "Pesanku kamu tidak perlu menjadi orang lain.",
  "Tetaplah menjadi dirimu sendiri,",
  "karena dengan itu yang akan membuatmu",
  "terlihat begitu istimewa.",
  "",
  "Aku mungkin baru mengenalmu beberapa minggu",
  "tidak berpengalaman, tidak terlalu mengenal",
  ...
  "",
  "Semoga tahun ini",
  "menjadi tahun yang jauh lebih baik",
  "daripada tahun sebelumnya.",
  "",
  "Semoga semua doa baikmu",
  "menemukan jalannya untuk terkabul.",
  "",
  "Jaga kesehatan.",
  ...
  "tidak selalu datang",
  "dari seseorang yang paling dekat.",
  "",
  "Happy birthday. 🎂",
  "",
];
